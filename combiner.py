...
if __name__ == '__main__':
    ...
    if args.plist:
        write_csv(c9_table_curr.plmn_make('G', 'mccmnc.txt'), 'plmn-G.txt')
        write_csv(c9_table_curr.plmn_make('G+', 'mccmnc.txt'), 'plmn-Gp.txt')
        write_csv(c9_table_curr.plmn_make('UL', 'mccmnc.txt'), 'plmn-UL.txt')
